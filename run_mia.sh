...
MIA_PROBABILISTIC_NUM_QUERIES=${MIA_PROBABILISTIC_NUM_QUERIES:-[1,10,100,1000,10000]}
MIA_PROBABILISTIC_THRESHOLDS=${MIA_PROBABILISTIC_THRESHOLDS:-${MIA_PROBABILISTIC_THRESHOLD:-[0.1,0.5,0.9,0.99,0.999]}}
...
run_mia_task() {
  ...
  CUDA_VISIBLE_DEVICES="$MIA_GPU_ID" "$MIA_PYTHON_BIN" src/eval.py \
    ...
    mia_probabilistic_probability_threshold="$MIA_PROBABILISTIC_THRESHOLDS" \
    ...
    mia_probabilistic_prefix_length="$MIA_PROBABILISTIC_PREFIX_LENGTH" \
